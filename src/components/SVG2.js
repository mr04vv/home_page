...
class SVG extends React.Component {
  ...
  componentDidMount() {
      let vi = new Vivus('canvas2', {start: 'manual', type: 'oneByOne', duration: 50});  
      setTimeout(() => {
        vi.play()
      },2500)    
}
